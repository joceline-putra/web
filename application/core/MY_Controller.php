    ...
    */
    ...
    public function get_firebase_config(){
        $return = array(
            ...
            'storageBucket' => $this->config->item('storageBucket'),
            'messagingSenderId' => $this->config->item('messagingSenderId'),
    ...
    public function file_upload_image($dir = "", $img_data = ""){ //Croppie
        $r          = new \stdClass();
        $r->status  = 0;
        $r->message = 'Failed';
        $r->result  = array();
    ...
    public function contact_number($contact_phone){ //Contact 0 / +62 to safe
