    ...
    $(document).ready(function () {
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                ...
                {"targets": 1, "title": "Lokasi", "searchable": true, "orderable": true},
            ...
            "columns": [{
                    ...
                    render: function (data, meta, row) {
                        var dsp = '';
                        dsp += row.location_lat+', '+row.location_lng+', <br> Jarak '+row.location_allow_radius;
                        return dsp;
                    }
                }, {
                    'data': 'location_note'
        ...
        $(document).on("click", "#btn-save", function (e) {
            ...
            if (next == true) {
                if ($("input[id='lng']").val().length == 0) {
                    notif(0, 'Longitude wajib diisi');
                    $("#lng").focus();
                    next = false;
                }
            }
            ...
            if (next == true) {
                if ($("input[id='distance']").val().length == 0) {
                    notif(0, 'Jarak wajib diisi');
                    $("#distance").focus();
                    next = false;
                }
            }
            ...
            $.ajax({
                ...
                success: function (d) {
                    if (parseInt(d.status) == 1) { /* Success Message */
                        ...
                        $("#form-master input[name='lat']").val(d.result.location_lat);
                        ...
                        $("select[name='branch']").append('' +
                                '<option value="' + d.result.location_branch_id + '">' +
                                d.result.branch_name +
                                '</option>');
                        $("select[name='branch']").val(d.result.location_branch_id).trigger('change');
