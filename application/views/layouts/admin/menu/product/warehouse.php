    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab1">
                <div class="col-md-8 col-xs-12 col-sm-12 padding remove-right prs-0">
                ...
                <div class="col-md-4 col-xs-12 col-sm-12 padding-remove-left prs-0">
                    <div class="grid simple">
                        <div class="hidden grid-title">
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                    <form id="form-master" name="form-master" method="" action="">    
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">    
                                            ...
                                            <div class="col-md-6 col-xs-4 col-sm-4 padding-remove-left">
                                                <div class="form-group">
                                                    <label class="form-label">Latitude *</label>
                                                    <input id="lat" name="lat" type="text" value="" class="form-control" readonly='true'/>
                                                </div>
                                            </div>                                      
                                            <div class="col-md-6 col-xs-4 col-sm-4 padding-remove-left">
                                                <div class="form-group">
                                                    <label class="form-label">Longitude *</label>
                                                    <input id="lng" name="lng" type="text" value="" class="form-control" readonly='true'/>
                                                </div>
                                            </div>   
                                            <div class="col-md-6 col-xs-4 col-sm-4 padding-remove-left">
                                                <div class="form-group">
                                                    <label class="form-label">Maksimal Jarak (meter)</label>
                                                    <input id="distance" name="distance" type="text" value="" class="form-control" readonly='true'/>
                                                </div>
                                            </div>                                                                                                                                          
                                            <!--
                                            <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
