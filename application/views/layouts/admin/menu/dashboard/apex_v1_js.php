...
<script>
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    if (parseInt(d.status) === 1) {
                        ...
                        /* Chart 1 */
                        // apexOption_4.series = result_buy;             
                        // apexOption_4.labels = labels;         
                        // apex_4.update();
    ...
    function total_cash_in_month(type) { /*Will Not Used, */ console.log('total_cash_in_month() 1');
    ...
    function total_cash_out_month(type) { /*Will Not Used */ console.log('total_cash_out_month() 1');
