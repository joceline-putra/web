    ...
    <div class="custom-slider-background overflow-hidden">
        <div class="custom-slider-background-image-stage-outer appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1600">
            <div class="custom-slider-background-image-stage">
                <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('<?php echo $asset; ?>'img/demos/architecture-2/slides/slide-1-1.jpg); background-size: cover; background-position: center;"></div>
                <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('<?php echo $asset; ?>'img/demos/architecture-2/slides/slide-1-2.jpg); background-size: cover; background-position: center;"></div>
                <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('<?php echo $asset; ?>'img/demos/architecture-2/generic/generic-1.jpg); background-size: cover; background-position: center;"></div>
                <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('<?php echo $asset; ?>'img/demos/architecture-2/generic/generic-2.jpg); background-size: cover; background-position: center;"></div>
            </div>
        </div>
        <div class="custom-slider-background-image-stage-outer appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1600">
                ...
                <div class="container container-xl-custom custom-container-style-2 position-relative z-index-3 h-100 pt-5 mt-5 mt-sm-3">
                    <div class="row align-items-center h-100">
                        <div class="col">
                            ...
                            <a href="#start" data-hash data-hash-offset="0" data-hash-offset-lg="140" class="btn btn-primary custom-btn-style-1 font-weight-bold text-3 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="750">GET STARTED</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container container-xl-custom custom-container-style-2 position-relative z-index-3 h-100 pt-5 mt-5 mt-sm-3">
                    <div class="row align-items-center justify-content-end h-100">
                        <div class="col text-end">
                            ...
                            <div class="overflow-hidden opacity-6 mb-5">
                                <p class="text-color-light text-3-5 mb-0 appear-animation d-none" data-appear-animation="maskUp" data-appear-animation-delay="500">Elegant Solutions to Complex Problems</p>
                            </div>
                            <a href="#start" data-hash data-hash-offset="0" data-hash-offset-lg="140" class="btn btn-primary custom-btn-style-1 custom-btn-style-1-right font-weight-bold text-3 px-5 py-3 appear-animation d-none" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="750">GET STARTED</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="position-relative">
    <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/backgrounds/arch-plan-1.jpg" class="img-fluid position-absolute top-0 right-0" alt="" />
</div>
    ...
    <section class="section bg-transparent border-0 position-relative py-0 m-0">
        <div class="container container-xl-custom custom-container-style custom-margin-top">
                            ...
                            <div class="owl-carousel owl-theme dots-horizontal-center custom-dots-style-1 mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 2}, '1200': {'items': 3}}, 'margin': 25, 'loop': true, 'nav': false, 'dots': true, 'autoplay': true, 'autoplayTimeout': 7000}">
                                    ...
                                    <a href="demo-architecture-2-services-detail.html" class="text-decoration-none">
                                        <div class="card custom-card-style-1 border-radius-0">
                                            <div class="card-body text-center p-5 mb-4">
                                                <img width="75" height="75" src="<?php echo $asset; ?>assets/img/demos/architecture-2/icons/house-plant.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mt-3 mb-4 pb-3'}" />
                                ...
                                <div>
                                    <a href="demo-architecture-2-services-detail.html" class="text-decoration-none">
                                        <div class="card custom-card-style-1 border-radius-0">
                                            <div class="card-body text-center p-5 mb-4">
                                                <img width="75" height="75" src="<?php echo $asset; ?>assets/img/demos/architecture-2/icons/sofa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mt-3 mb-4 pb-3'}" />
                                ...
                                <div>
                                    <a href="demo-architecture-2-services-detail.html" class="text-decoration-none">
                                        <div class="card custom-card-style-1 border-radius-0">
                                            <div class="card-body text-center p-5 mb-4">
                                                <img width="75" height="75" src="<?php echo $asset; ?>assets/img/demos/architecture-2/icons/wallpaper.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mt-3 mb-4 pb-3'}" />
            ...
            <div id="start" class="row align-items-center pb-xl-5 mb-xl-5">
                <div class="col-9 col-lg-4 col-xl-5 pb-5 pb-lg-0 mb-5 mb-lg-0">
                    <div class="position-relative">
                        <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/backgrounds/arch-plan-2.jpg" class="img-fluid position-absolute left-0 z-index-0 appear-animation" alt="" data-appear-animation="fadeIn" data-appear-animation-delay="850" style="bottom: -168px;" />
                        <div class="overflow-hidden position-relative z-index-1">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-1.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="maskLeft" data-appear-animation-delay="250" />
                        </div>
                        <div class="overflow-hidden position-absolute z-index-2" style="bottom: -75px; right: -17%;">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-2.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="maskRight" data-appear-animation-delay="550" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-xl-5 offset-lg-1 position-relative pt-5 pt-lg-0">
                    ...
                    <div class="pt-lg-5 ps-lg-5 mt-lg-5">
                        ...
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/divider.jpg" class="img-fluid opacity-5 mb-4" alt="" />
                        </div>
        ...
        <div class="container-fluid">
            <div class="row pt-5">
                <div class="col text-center">
                    <h2 class="text-color-dark font-weight-bold text-10 mb-5-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200">Klien & Partner</h2>
                </div>
            </div>
        </div>
        <div class="container container-xl-custom pb-3">
            <div class="row align-items-center text-center py-5 my-3">
                ...
                $set_image = !empty($v['news_image']) ? $v['news_image'] : site_url('upload/noimage.png');
                $set_title = substr($v['news_title'], 0, 50);
                ?>                      
                <?php 
                // foreach($client as $u):
                ?>                                
                <div class="col-sm-4 col-xl-2 mb-5 mb-xl-0 img-portofolio mb-5-5">
                    <img src="<?php echo $set_image; ?>" alt class="img-fluid">
                </div>
                <?php 
                }
                // endforeach;
        ...
        <div class="custom-section">
            <div class="custom-section-left-content parallax p-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'fadeIn': true}" data-image-src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-3.jpg" style="min-height: 400px"></div>
            <div class="custom-section-middle-content bg-primary p-5">
                <div class="owl-carousel owl-theme nav-style-1 nav-svg-arrows-1 nav-light custom-hide-prev-nav custom-dots-style-1 custom-dots-style-1-light mb-0" data-plugin-options="{'responsive': {'0': { 'items': 1}, '576': {'items': 1}, '768': {'items': 1, 'dots': true, 'nav': false}, '992': {'items': 1}, '1200': {'items': 1}}, 'loop': true, 'nav': true, 'dots': false, 'margin': 20, 'refresh': true}">
                    <div class="pt-4 pb-3">
                        ...
                        <p class="text-3-5 text-color-light opacity-4 pe-5 pe-md-0 pe-lg-5 me-3 me-md-0 me-lg-3 mb-0">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac.</p>
                    </div>
                    <div class="pt-4 pb-3">
                        <h2 class="custom-heading-style-1 text-4-5 mb-4">
            ...
            <div class="custom-section-right-content parallax p-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 3, 'parallaxDirection': 'bottom', 'fadeIn': true}" data-image-src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-4.jpg" style="min-height: 400px"></div>
        </div>
        <!-- <div class="container container-xl-custom py-5 mt-5 mb-4">
            <div class="row py-4">
                <div class="col-lg-5 col-xl-4 position-relative mb-4">
                    ...
                    <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/divider.jpg" class="img-fluid opacity-5 mb-4 mt-2" alt="" />
        ...
        <div class="container py-2">
            <div class="row counters counters-sm">
                <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-12 mb-2" data-to="15" data-append="+">0</strong>
                        <label class="text-color-default positive-ls-3 font-weight-normal text-3-5 mb-0">YEARS OF EXPERIENCE</label>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-12 mb-2" data-to="350" data-append="+">0</strong>
                        <label class="text-color-default positive-ls-3 font-weight-normal text-3-5 mb-0">SATISFIED CLIENTS</label>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-5 mb-sm-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-12 mb-2" data-to="20" data-append="+">0</strong>
                        <label class="text-color-default positive-ls-3 font-weight-normal text-3-5 mb-0">TEAM MEMBERS</label>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-12 mb-2" data-to="45" data-append="+">0</strong>
                        <label class="text-color-default positive-ls-3 font-weight-normal text-3-5 mb-0">AWARDS WINNING</label>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="masonry row" data-plugin-masonry data-plugin-options="{'layoutMode': 'packery', 'itemSelector': '.masonry-item', 'sortBy': 'original-order'}">
                    <div class="masonry-item no-default-style col-6 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-5.jpg" data-appear-animation="maskDown" data-appear-animation-delay="500">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-5.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                    <div class="masonry-item no-default-style col-6 col-lg-3 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-6.jpg" data-appear-animation="maskRight" data-appear-animation-delay="250">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-6.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                    <div class="masonry-item no-default-style col-6 col-lg-3 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-7.jpg" data-appear-animation="maskLeft" data-appear-animation-delay="750">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-7.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                    <div class="masonry-item no-default-style col-6 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-10.jpg" data-appear-animation="maskUp" data-appear-animation-delay="500">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-10.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                    <div class="masonry-item no-default-style col-6 col-lg-3 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-8.jpg" data-appear-animation="maskRight" data-appear-animation-delay="750">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-8.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                    <div class="masonry-item no-default-style col-6 col-lg-3 overflow-hidden px-0">
                        <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0 appear-animation" href="img/demos/architecture-2/generic/generic-9.jpg" data-appear-animation="maskLeft" data-appear-animation-delay="250">
                            <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/generic/generic-9.jpg" class="img-fluid rounded-0" alt="" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-xl-8 appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="500" data-plugin-options="{'accY': -400}">
                <div class="custom-accordion-style-1 accordion accordion-modern" id="FAQAccordion">
                    <div class="card card-default">
                        <div class="card-header">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold" data-bs-toggle="collapse" href="#collapseFAQOne">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold" data-bs-toggle="collapse" href="#collapseFAQTwo">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold" data-bs-toggle="collapse" href="#collapseFAQFour">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold" data-bs-toggle="collapse" href="#collapseFAQFive">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold" data-bs-toggle="collapse" href="#collapseFAQTSix">
                ...
                <div class="owl-carousel owl-theme nav-style-1 nav-outside nav-font-size-lg custom-nav-grey mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 2}, '992': {'items': 1}, '1200': {'items': 2}}, 'loop': true, 'nav': true, 'dots': false, 'margin': 20}">
                    <div>
                        <div class="card border-radius-0">
                            <img class="card-img-top border-radius-0" src="<?php echo $asset; ?>assets/img/demos/architecture-2/authors/author-1.jpg" alt="" />
                    ...
                    <div>
                        <div class="card border-radius-0">
                            <img class="card-img-top border-radius-0" src="<?php echo $asset; ?>assets/img/demos/architecture-2/authors/author-2.jpg" alt="" />
                            <div class="card-body text-center">
        ...
        <div class="container container-xl-custom py-5">
            <div class="row">
                <div class="col text-center position-relative">
                    ...
                    <!-- <h2 class="text-color-default positive-ls-3 line-height-3 text-4 mb-2">Blog</h2> -->
                    <h3 class="text-transform-none text-color-dark font-weight-black text-10 line-height-2 mb-3">Murba Terkini</h3>
                    <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/divider.jpg" class="img-fluid opacity-5 mt-3 mb-5" alt="" />
                </div>
            </div>
            <div class="row row-gutter-sm">
                <?php
                $s = 1; 
                // var_dump($news['news_new']);die;
                foreach ($news['news_new'] as $v) {
                // $set_url = $pages['sitelink']['categories']['url'] . '/' . $v['news_url'];
                $set_image = $v['image'];
                $set_title = substr($v['title'], 0, 50);
                $set_content = strip_tags(substr($v['content'], 0, 50),'');
                ...
                $s++;
                ?>                      
                <div class="col-lg-4 <?php echo $ss;?>">
                    <article>
                        <div class="card border-0 border-radius-0">
                            <div class="card-body bg-color-grey p-4 z-index-1">
                                <a href="<?php echo $v['url']; ?>">
                                    <img class="card-img-top border-radius-0 hover-effect-2" src="<?php echo $set_image; ?>" alt="<?php echo $set_title;?>">
                                </a>
                                <p class="text-uppercase text-1 mb-3 pt-1 text-color-default">
                                    <time pubdate datetime="2024-01-10"><?php echo date("d M Y", strtotime($v['created']))?></time> 
                                    <!-- <span class="opacity-3 d-inline-block px-2">|</span>  -->
                                    <!-- 3 Comments  -->
                                    <span class="opacity-3 d-inline-block px-2">|</span> 
                                    By <?php echo $v['author']; ?>
                                </p>
                                <div class="card-body p-0">
                                    <h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none font-weight-bold text-3-5" href="<?php echo $v['url']; ?>"><?php echo $set_content;?></a></h4>
                                    <!-- <p class="card-text mb-2"><?php #echo $set_content; ?></p> -->
                                    <!-- <a href="<?php #echo $v['url']; ?>" class="custom-read-more d-inline-flex align-items-center font-weight-semibold text-3 text-decoration-none ps-0">
                                        READ MORE +
                                    </a> -->
                                </div>
                            </div>
                        ...
                        <div class="card border-0 border-radius-0">
                            <div class="card-body bg-color-grey p-4 z-index-1">
                                <a href="demo-architecture-2-blog-post.html">
                                    <img class="card-img-top border-radius-0 hover-effect-2" src="<?php echo $asset; ?>assets/img/demos/architecture-2/blog/blog-thumb-2.jpg" alt="Card Image">
                                </a>
                                <p class="text-uppercase text-1 mb-3 pt-1 text-color-default">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <a href="demo-architecture-2-blog-post.html" class="custom-read-more d-inline-flex align-items-center font-weight-semibold text-3 text-decoration-none ps-0">
                                        READ MORE +
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="card border-0 border-radius-0">
                            <div class="card-body bg-color-grey p-4 z-index-1">
                                <a href="demo-architecture-2-blog-post.html">
                                    <img class="card-img-top border-radius-0 hover-effect-2" src="<?php echo $asset; ?>assets/img/demos/architecture-2/blog/blog-thumb-3.jpg" alt="Card Image">
                                </a>
                                <p class="text-uppercase text-1 mb-3 pt-1 text-color-default">
                                    <time pubdate datetime="2024-01-10">10 Jan 2024</time> 
                                    <span class="opacity-3 d-inline-block px-2">|</span> 
...
<div class="position-relative" style="margin-top: 50px;">
    <img src="<?php echo $asset; ?>assets/img/demos/architecture-2/backgrounds/arch-plan-3.jpg" class="img-fluid position-absolute bottom-0 left-0" alt="" />
</div>

<div class="container pt-4 mt-5">
    <div class="row">
        <div class="col text-center">
            <h2 class="text-color-dark font-weight-bold text-10 mb-5-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200">Our Project</h2>
        </div>
    </div>
    <div class="row g-4 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400">
        <div class="col-md-6">
            <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                    <div class="thumb-info-wrapper rounded-0">
                        <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-1.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                        <div class="thumb-info-title px-5-5 py-5-5">
                            <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                            <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <div class="row g-4">
                <div class="col-12">
                    <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                        <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                            <div class="thumb-info-wrapper rounded-0">
                                <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-2.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                                <div class="thumb-info-title px-5-5 py-5-5">
                                    <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                                    <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                                </div>
                ...
                <div class="col-md-6">
                    <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                        <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                            <div class="thumb-info-wrapper rounded-0">
                                <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-3.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                                <div class="thumb-info-title px-5-5 py-5-5">
                                    <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                                    <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                                </div>
                ...
                <div class="col-md-6">
                    <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                        <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                            <div class="thumb-info-wrapper rounded-0">
                                <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-4.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                                <div class="thumb-info-title px-5-5 py-5-5">
                                    <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                                    <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                                </div>
        ...
        <div class="col-md-3">
            <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                    <div class="thumb-info-wrapper rounded-0">
                        <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-5.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                        <div class="thumb-info-title px-5-5 py-5-5">
                            <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                            <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                        </div>
        ...
        <div class="col-md-6">
            <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                    <div class="thumb-info-wrapper rounded-0">
                        <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-6.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                        <div class="thumb-info-title px-5-5 py-5-5">
                            <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                            <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                        </div>
        ...
        <div class="col-md-3">
            <a href="portfolio-single-wide-slider.html" class="text-decoration-none">
                <div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-dark-linear thumb-info-centered-icons rounded-0">
                    <div class="thumb-info-wrapper rounded-0">
                        <img src="<?php echo $asset; ?>assets/img/projects/project-corporate-21-7.jpg" class="img-fluid rounded-0" alt="Portfolio Project Image">
                        <div class="thumb-info-title px-5-5 py-5-5">
                            <h3 class="thumb-info-inner line-height-1 text-transform-none text-color-light font-weight-semibold text-5 mb-0">Project Title</h3>
                            <span class="thumb-info-type font-weight-light line-height-1 text-1">Project Type</span>
                        </div>
    ...
    <div class="row mt-5-5">
        <div class="col text-center">
            <a href="portfolio-grid-4-columns.html" class="btn btn-dark btn-rounded font-weight-bold text-3-5 btn-py-3 px-5 mb-5">VIEW PORTFOLIO</a>
        </div>
    </div>
</div>  