			...
			<div class="page-header">
				<div class="container d-flex flex-column align-items-center">
					<nav aria-label="breadcrumb" class="breadcrumb-nav">
						<div class="container">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo $link['home'];?>">Home</a></li>
				...
				<div class="row">
					<div class="sidebar widget widget-dashboard mb-lg-0 mb-3 col-lg-3 order-0">
						...
						<ul class="nav nav-tabs list flex-column mb-0" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link" href="<?php echo $link['wishlist'];?>">Wishlist</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="<?php echo $link['signout'];?>">Logout</a>
							</li>
						</ul>
					</div>
						...
						<div class="tab-pane fade show active" id="dashboard" role="tabpanel">
							<div class="dashboard-content">
								<p>
									...
									<a href="<?php echo $link['signout'];?>" class="btn btn-link ">Log out</a>)
								</p>
								...
								<div class="row row-lg">
									...
									<div class="col-6 col-md-4">
										<div class="feature-box text-center pb-4">
											<a href="<?php echo $link['wishlist'];?>"><i class="sicon-heart"></i></a>
											<div class="feature-box-content">
												<h3>WISHLIST</h3>
											</div>
										</div>
									...
									<div class="col-6 col-md-4">
										<div class="feature-box text-center pb-4">
											<a href="<?php echo $link['signout'];?>"><i class="sicon-logout"></i></a>
											<div class="feature-box-content">
												<h3>LOGOUT</h3>
											</div>
										</div>
						...
						<div class="tab-pane fade" id="order" role="tabpanel">
							<div class="order-content">
								...
								<div class="order-table-container text-center">
									...
									<a href="<?php echo $link['home'];?>" class="btn btn-dark">Go Shop</a>
								</div>
							</div>
						</div><!-- End .tab-pane -->
						...
						<div class="tab-pane fade" id="download" role="tabpanel">
							<div class="download-content">
								...
								<div class="download-table-container">
									<p>No downloads available yet.</p> <a href="<?php echo $link['home'];?>"
							...
							<div class="account-content">
								<form action="#">
									...
									<div class="form-footer mt-3 mb-0">
										<button id="btn_save_profile" type="button" class="btn btn-dark mr-0">
											Save changes
										</button>
									</div>
								</form>
								...
								<form class="mb-2" action="#">
									...
									<div class="form-footer mb-0">
										<div class="form-footer-right">
											<button id="btn_save_address_billing" type="button" class="btn btn-dark py-4">
												Save Address
											</button>
										</div>
									</div>
						...
						<div class="tab-pane fade" id="shipping" role="tabpanel">
							<div class="address account-content mt-0 pt-2">
								...
								<form class="mb-2" action="#">
									...
									<div class="form-footer mb-0">
										<div class="form-footer-right">
                                            <button id="btn_save_address_shipping" type="button" class="btn btn-dark py-4">
												Save Address
											</button>
										</div>
									</div>
