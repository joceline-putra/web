...
class Kontak extends MY_Controller{
                    ...
                    if($check_exists==false){
                        ...
                        */
                        $params = array(
                            ...
                            'contact_phone_1' => !empty($this->input->post('telepon_1')) ? phone_format('62',$this->input->post('telepon_1')) : null,
    ...
    function export_to_excel(){
        // https://www.studentstutorial.com/php-spreadsheet/export-data-phpspreadsheet
        ...
        /* get employee list */
        $empInfo = $this->Kontak_model->get_all_kontaks(null,null,null,null,null,null);
        // $fileName = 'contact-'.time(); 
        $fileName = 'contact';
        ...
        $sheet->setCellValue('A1', 'First_Name');
            ...
            foreach ($empInfo as $element) {
                $sheet->setCellValue('A' . $rowCount, $element['contact_id']);
                $sheet->setCellValue('B' . $rowCount, $element['contact_code']);
                $sheet->setCellValue('C' . $rowCount, $element['contact_name']);
                $sheet->setCellValue('D' . $rowCount, $element['contact_id']);
                $sheet->setCellValue('E' . $rowCount, $element['contact_id']);
                $rowCount++;
            }
            if($extension == 'csv'){          
        ...
        $filepath = file_get_contents(FCPATH.'download/'.$fileName);
        force_download($fileName, $filepath);
    }
    function import_from_excel(){
        // https://www.studentstutorial.com/php-spreadsheet/Import-excel-data-php-spreadsheet        
    }
}
