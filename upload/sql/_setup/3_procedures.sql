...
CREATE PROCEDURE `sp_chart_buy_sell`(IN vBRANCH BIGINT(255))
    BEGIN
        ...
        CREATE TEMPORARY TABLE `temp`(
            ...
            `temp_label` VARCHAR(255),
            `temp_name` VARCHAR(255),
            `temp_total_buy` DOUBLE(18,0) DEFAULT 0,
            `temp_total_sell` DOUBLE(18,0) DEFAULT 0,
            `temp_total_income` DOUBLE(18,0) DEFAULT 0,
            `temp_total_expense` DOUBLE(18,0) DEFAULT 0,            
            `temp_flag` INT(5) DEFAULT 0,
            `temp_status` INT(5) DEFAULT 0,
        ...
        BLOCK_A:BEGIN
            ...
            DECLARE mACTION_CURSOR CURSOR FOR
                ...
                FROM trans 
                WHERE trans_date > DATE_SUB(NOW(), INTERVAL 3 MONTH)
        ...
        BLOCK_B:BEGIN
            ...
            SET temp_total_buy=ROUND(trans.total,0)
        ...
        BLOCK_C:BEGIN
            ...
            SET temp_total_sell=ROUND(trans.total,0)
            WHERE temp.temp_label=trans.years_month;
        ...
        BLOCK_C:BEGIN
            ...
            SET temp_total_income=ROUND(journals.total)
        ...
        BLOCK_D:BEGIN
            ...
            SET temp_total_expense=ROUND(journals.total)
            WHERE temp.temp_label=journals.years_month;
        END BLOCK_D;
